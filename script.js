...
async function main() {
  // const model = await tf.loadGraphModel('model_directory/model.json');
  const model = await tf.loadGraphModel("http://192.168.1.35:1883/getmodel/model.json");
  // use back main camera
